...
class Postprocessor():
    #It's kind of a worker, or layer on top of the generated file PER User. It is instantiated per User.
    ...
    def addEffects(self):
        ...
        #.reverb(reverberance=50, room_scale=50, hf_damping=50, wet_only=True)
